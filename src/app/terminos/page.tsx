        ...
        <div className={`bg-white rounded-3xl shadow-2xl p-8 md:p-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-3">
                <p className="leading-relaxed">
                  <strong>6.1 Inscripción:</strong> Desde el momento de registro hasta el 27 de febrero de 2026.
                </p>
                <p className="leading-relaxed">
                  <strong>6.2 Sorteo:</strong> Viernes 27 de febrero de 2026 a las 12:00 p.m. (Hora de Perú).
                </p>
                <p className="leading-relaxed">
